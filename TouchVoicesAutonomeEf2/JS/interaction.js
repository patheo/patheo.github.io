  ...
  .draggable({
    ...
    onmove: function (event) {
      ...
      if(x > 0 && x < (windowWidth-100) && y > 0 && y < (windowHeight-100)){
        ...
        effet2v200.setValue("/0x00/" + "MovX" + target.getAttribute('id').substr(0,1), (x + 50 - (windowWidth/2))/50);
        effet2v200.setValue("/0x00/" + "MovY" + target.getAttribute('id').substr(0,1), ((y + 50 - (windowHeight/2))/50)*(-1));
...
interact('.buttonFixe')
  .on('tap', function (event) {
    ...
    if(buttonAct == "V"){
      ...
      effet2v200.setValue("/0x00/" + "opt" + noeudAct, buttonAct);
...
interact('.effetMvt')
  .draggable({
    ...
    if(x > 0 && x < 190 && y > 0 && y < 190){
      ...
      effet2v200.setValue("/0x00/" + effet[buttonAct]+ "X" + noeudAct, x);
      effet2v200.setValue("/0x00/" + effet[buttonAct]+ "Y" + noeudAct, (189-y));
      console.log(
  ...
  .on('tap', function (event) {
    ...
    effet2v200.setValue("/0x00/" +effet[buttonAct]+ "B" + noeudAct, etat);
